...
const styles = StyleSheet.create({
  // Full-screen background wrapper (fixes “doesn’t fill bottom”)
  bg: {
    flex: 1,
  },
  // Tweak to taste: increase opacity for stronger background image
  bgImage: {
    opacity: 0.28,
  },

  // ScrollView content container MUST be flexGrow to fill the viewport
  screen: {
    flexGrow: 1,
  ...
  // Center everything inside the cards
  card: {
    width: '48%',
    backgroundColor: COLORS.surface,
    borderRadius: 22,
